...
const FundRiserForm = () => {
  ...
  return (
    <>
        <h1 className="font-sans font-bold text-xl">Start a fund raiser!</h1>
        <form onSubmit={(e)=>riseFund(e)}>
            ...
            <button className="p-2 w-full bg-[#2563EB] text-white rounded-md hover:bg-[#2563a2]" disabled={btnLoading} >{btnLoading?"Loading...":"Raise fund"}</button>
        </form>
    </>
  )
}
